...
from point_clouds.simpleview_model_utils import Squeeze, BatchNormPoint
from point_clouds.simpleview_utils import PCViews


class MVModel(nn.Module):
    def __init__(self,  backbone:str = 'resnet18',feat_size:int = 16,  num_class: int = 40):
    ...
    def get_img_layers(backbone, feat_size):
        ...
        from point_clouds.resnet import _resnet, BasicBlock
